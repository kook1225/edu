...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(10 , CGRectGetMaxY(_topImageView.frame) + 5, _mainView.frame.size.width - 15, 20)];
...
- (void)setData:(ProductListModel *)model {
    ...
    NSString *saledStr = [NSString stringWithFormat:@"已销%@%@",model.salecount,model.unit];
    ...
    [attri2 addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithRed:255.0/255.0 green:42.0/255.0 blue:45.0/255.0 alpha:1.000]
                   range:NSMakeRange(2, [model.salecount length])];
